            ...
            <div class="row-fluid">
              <div class="span5">
                <table class="">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td><h4>OneLife Swimming Academy</h4></td>
                    </tr>
                    <tr>
                      <td>10 Dosert Road East, Mount Pleasant, Harare, Zimbabwe</td>
                    </tr>
                    
                    <tr>
                      <td>Whatsapp : 077322095</td>
                    </tr>
                    <tr>
                      <td >Email: onelife@gmail.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="span7">
                ...
                <select name="plan" required="required" id="select">
                  <option value="1" selected="selected" >Daily Pass</option>
                  <option value="7">Weekly Pass</option>
                  <option value="30">Monthly Pass</option>
