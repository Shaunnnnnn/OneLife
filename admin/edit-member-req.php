...
<form role="form" action="index.php" method="POST">
    <?php 
            ...
            //update query
            $qry = "update members set fullname='$fullname', dor='$dor', gender='$gender', services='$services', amount='$totalamount', plan='$plan', contact='$contact', p_year='$p_year', paid_date='$paid_date', expiry_date='$expiry_date', status='$status' where user_id='$id'";
