...
<div id="content-header">
  ...
  <h1 style="background-color: #336699; color: white;">Update Member Details</h1>
    </div>
            ...
            <div class="widget-content nopadding">
              <form action="edit-member-req.php" method="POST" class="form-horizontal">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" class="span11" name="fullname" placeholder="Fullname" value="<?php echo $row['fullname']; ?>" required="required"/>
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="date" name="dor" class="span11" value="<?php echo $row['dor']; ?>" required="required"/>
            ...
            <div class="widget-content nopadding">
              <div class="form-horizontal">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="number" id="mask-phone" name="contact" placeholder="e.g0779777159" class="span8 mask text" value="<?php echo $row['contact']; ?>" required="required">
              ...
              <div class="controls">
                <div class="input-append">
                  ...
                  <input type="number" value='<?php echo $row['amount']; ?>' name="amount" class="span11" required="required">
                  </div>
              </div>
            </div>
