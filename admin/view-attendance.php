...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">OneLIfe</a></h1>
</div>
<!--close-Header-part--> 
            ...
            <table class='table table-bordered' id="attendanceTable">
              ...
              <?php include "dbcon.php";
                ...
                <tbody> 
                  ...
                  <td><div class='text-center'><?php if($row['plan'] == 1) { echo $row['plan']. '';} else if($row['plan'] == '0') { echo'Expired';} else { echo $row['plan']. ''; } ?></div></td>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Gavi Praise and Shaun Mango </a> </div>
</div>
